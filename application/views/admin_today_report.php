...
<?php if($user!=NULL){?>
                <div class="row">
                  <div class="col-lg-8 task-progress pull-left">
                    <h1>All products sold by <?php echo $user->Full_name. " on ". date('Y-m-d');?></h1>
                  </div>
                </div>
<?php } ?>
                <br>
            ...
            <table class="table table-hover product_list">
              ...
              <br>
                ...
                <div class="row">
                <div class="col-md-12">
                <a  class="btn btn-sm btn-info" href="<?php echo base_url();?>index.php/Welcome/Print">Print</a></div>
                </div>
                </div>
