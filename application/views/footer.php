	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	       <?php echo form_open("Welcome/Report", ['class'=>'form_report', 'method'=>'POST']);?>
	          <div class="form-group">
	            <label for="date_report" class="col-form-label">Enter date</label>
	            <input type="date" class="form-control" required name="date_report" id="date_report">
	          </div>
	          <div>
...
<div class="modal fade" id="durationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <?php echo form_open("Welcome/Duration", ['class'=>'interval_report', 'method'=>'POST']);?>
			<div class="form-group">
				<div class="row">
				    <div class="col-md-6">
