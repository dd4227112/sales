...
<div class="panel-body progress-panel">
                <div class="row">
                  <div class="col-lg-8 task-progress pull-left">
                    <h1>Sales report from  <?php echo $date1;?> to <?php echo $date2;?></h1>
                  </div>
                </div>
            ...
            <table class="table table-hover product_list">
              <thead>
                ...
                <tr>
                <td></td>
                <td class="text-center text-success">Total(Rejareja)Tsh.</td>
                <td class="text-center"></td>
                <td class="text-center text-success"><?php echo $rejareja_jumla."/=";?></td>
            ...
            <table class="table table-hover product_list">
              <thead>
                ...
                <tr>
                <td></td>
                <td class="text-center text-success">Total(Jumla)Tsh.</td>
                <td class="text-center"></td>
                <td class="text-center text-success"><?php echo $jumla_jumla."/=";?></td>
                </tr>
                </tbody>
                </table>
                <?php } ?>
            ...
            <table class="table table-hover product_list">
              <thead>
                ...
                <tr>
                <td colspan="4"></td>
                <td class="text-center text-success">Service cost(total)Tsh.</td>
                <td class="text-center text-success"><?php echo $costs."/=";?></td>
                </tr>
                </tbody>
                </table>
                <?php } ?>
            ...
            <table class="table table-hover product_list">
              <thead>
                ...
                <tr>
                <td colspan="5"></td>
                <td class="text-center text-success">Total(Madeni)Tsh.</td>
                <td></td>
                <td class="text-center text-success"><?php echo $madeni_jumla."/=";?></td>
                <td></td>
                <td></td>
                </tr>
                </tbody>
              ...
              <div class="row">
                  <div class="col-lg-6 task-progress pull-left">
                    <h1 class="bg-success">Total Credit payed is 
                    <?php 
              if ($payed_credit==NULL OR $payed_credit->payed<=0){
                ...
                echo  number_format($payed_credit->payed, 2)."/=</h1>";
                  ...
                  <!-- <div class="col-lg-6 task-progress pull-left">
                   <button class="btn btn-sm btn-primary viewpay">View credit payment</button>
                  </div> -->
                </div>
              <?php } ?>
              <br>
              ...
              <br>
              <!-- Print report -->
              <?php if($rejareja_jumla+$jumla_jumla+$costs >0){?>
                <div class="row">
                <div class="col-md-12">
                <?php echo form_open('Welcome/Print_periodic', ['class'=>'print']);?>
                <input type="hidden" id="date" name="Date1" value="<?php echo $date1;?>">
                <input type="hidden" id="date" name="Date2" value="<?php echo $date2;?>">
          ...
          <table class="table table-hover">
           ...
           //  foreach($deni_leo as $leo):?>
            ...
            <?php // $leo_total+=$leo->Amount_payed;?> -->
                       <!-- <td><a class="lipa_deni btn btn-success btn-sm" href="javascript:;" id="<?php // echo $products->Product_id; ?>">Pay</a></td> -->
                  <!-- </tr> -->
                  <?php //endforeach; } ?>
  ...
  $(document).ready(function(){
    ...
    $('.view_detail').on("click", function(){     
      var id=$(this).attr("id");
        $.ajax({
        method: 'get',
        url: '<?php echo base_url();?>index.php/Welcome/getsalesdetailrejareja',
        data: {id:id},
        async:'false',
        dataType:'json',
    ...
    $('.view_details').on("click", function(){     
      var id=$(this).attr("id");
        $.ajax({
        method: 'get',
        url: '<?php echo base_url();?>index.php/Welcome/getsalesdetailjumla',
        data: {id:id},
        async:'false',
        dataType:'json',
          success:function(data){
